...
class _ContactPage extends State<ContactPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const String imgUrl = 'images/menu-talleres/movil/contacto-m.webp';
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    SizedBox(
                                      width: (constraints2.maxWidth - 116) * .5,
                                      child: RichText(
                                        text: TextSpan(
                                          style: TextStyle(
                                            fontSize: 16,
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () {
                                  Clipboard.setData(
                                          ClipboardData(text: '442 708 6211'))
                                      .then((value) {
                                    //only if ->
